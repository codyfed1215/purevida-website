...
- **Corporate offices** — from single-suite to multi-floor
...
Any group of people meeting together on a regular basis is a fit for our solution. The only vertical we don't serve is restaurants.

## Where Does PureVida Provide Service?

Because our model includes ongoing maintenance and support, we serve businesses within our three Texas metro areas:

- **[Dallas–Fort Worth](/locations/dallas)** — the greater DFW metroplex
- **[Austin](/locations/austin)** — the greater Austin metro area
- **[San Antonio](/locations/san-antonio)** — the greater San Antonio metro area

Not sure if you're in our service area? [Contact us](/contact) and we'll let you know right away.

## How Does the Filtration Work?

Every PureVida system uses advanced, 6-stage filtration that purifies your water right at the point of dispensing. Here's what each stage does:

1. **Sediment filtration** — removes dirt, rust, and particulate matter
2. **Carbon block filtration** — removes chlorine, taste, and odor compounds
3. **Reverse osmosis membrane** — filters down to 0.0001 microns, removing [PFAS](/blog/pfas-texas-drinking-water), heavy metals, and dissolved contaminants
4. **Granular activated carbon** — polishes the water and removes any residual taste or odor
5. **Remineralization and pH boost** — adds back beneficial minerals and balances pH for better taste
6. **Activated oxygen (ozonation) or UV light** — provides final-stage disinfection and prevents bacterial growth

The result is water that's cleaner, healthier, and better tasting than anything from a bottle. Most customers notice the difference from day one.

## How Does Installation Work?

Our service technicians handle the entire installation, and it's simpler than most people expect.

We use push-to-connect fittings and quarter-inch polyethylene tubing that runs from the back of the system to the closest water source — typically a kitchen or breakroom sink. The water source doesn't have to be right next to the unit. If you think of all the data cabling and wiring running through your facility, often hidden and unnoticed, our installation process works the same way.

The whole process can take as little as 45 minutes with zero disruption to your workday.

## How Does Ongoing Service Work?

Once your system is installed, here's what to expect:

- **Filter changes** — we swap out different sets of internal filters on an annual basis, so if nothing goes wrong, you'll see us about every 12 months
- **Repairs** — if the system ever malfunctions, call us and we come out to fix it. If we can't fix it, we replace it
- **No extra charges** — all parts, filters, filter changes, and service calls are included in your monthly fee
